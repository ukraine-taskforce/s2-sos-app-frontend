    ...
    switch (service.type) {
        case 'supplies':
            return {
                title: service.name,
                leading: (
                    <ImgSupply fill='var(--color-secondary-dark)'></ImgSupply>
                ),
                trailing: (
        ...
        case 'chat':
            return {
                title: service.name,
                leading: (
                    <ImgSpeech fill='var(--color-secondary-dark)'></ImgSpeech>
                ),
                trailing: (
                    <ImgMessenger fill='var(--color-secondary-dark)'></ImgMessenger>
                ),
                onAction: redirect,
            };
        case 'external':
        default:
            return {
                title: service.name,
                trailing: (
                    <ImgExternalLink fill='var(--color-secondary-dark)'></ImgExternalLink>
                ),
                onAction: redirect,
            };
    }
